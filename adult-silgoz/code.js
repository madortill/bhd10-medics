const termList = [
    {
        quess: 'מהו הטיפול בחסימת נ"א חלקית על רקע גו"ז במטופל מבוגר?',
        ans0: "עידוד שיעול",
        ans1: "טפיחה על הגב",
        ans2: "תמרון היימליך",
        ans3: "לחיצות חזה",
    ...
    {
        quess: 'מהו הטיפול בחסימת נ"א מלאה על רקע גו"ז במטופל מבוגר בהכרה?',
        ans0: "תמרון היימליך",
        ans1: "טפיחה על הגב",
        ans2: "עידוד שיעול",
        ans3: "לחיצות חזה",
    ...
    {
        quess: 'מהו הטיפול בחסימת נ"א מלאה על רקע גו"ז במחוסר הכרה?',
        ans0: "החייאה מלאה",
        ans1: "ביצוע לחיצות בצמוד לקיר",
        ans2: "תמרון היימליך",
        ans3: 'חיפוש הגוף הזר ושליפתו ידנית',
        img: "#"
    },
    {
        quess: "איך נבדיל בין חסימה מלאה לחלקית?",
        ans0: 'בחסימה חלקית המטופל משתעל ומשמיע קולות בעוד בחסימה מלאה המטופל לא מסוגל להשתעל ולהשמיע קולות',
        ans1: 'בחסימה מלאה המטופל משתעל ומשמיע קולות בעוד בחסימה חלקית המטופל לא מסוגל להשתעל ולהשמיע קולות',
        ans2: 'בחסימה חלקית המטופל בהכרה בעוד בחסימה מלאה המטופל מחוסר הכרה',
        ans3: 'בחסימה מלאה המטופל בהכרה בעוד בחסימה חלקית המטופל מחוסר הכרה',
        img: "#"
    }
...
const quesValue = ["0", "1,000", "100,000", "500,000", "1,000,000"];
