const termList = [
    {
        quess: 'מהו הטיפול בחסימת נתיב אוויר חלקית על רקע גו"ז בתינוקות ובילדים?',
        ans0: "אין לגעת בילד או בתינוק, בילדים יש לעודד שיעול",
        ans1: "אין לגעת בילד או בתינוק, בשניהם יש לעודד שיעול",
        ans2: "יש לטפוח על השכמות גם סילדים וגם במבוגרים",
        ans3: "ביצוע החייאה מלאה על פי הסכימה",
        img: "#"
    },
    {
        quess: 'מהו הטיפול בחסימת נתיב אוויר מלאה על רגע סילגו"ז בתינוקות בהכרה?',
        ans0: "5 טפיחות בין השכמות- 5 עיסויי חזה - הסתכלות לחלל הפה",
        ans1: "10 עיסויי חזה - הסתכלות לחלל הפה - 2 הנשמות",
        ans2: "3 טפיחות בין השכמות - הנשמה - 3 עיסויי חזה",
        ans3: "5 טפיחות בין השכמות - 5 טפיחות על הבטן - הסתכלות לחלל הפה",
        img: "#"
    },
    {
        quess: 'מהו הטיפול בחסימת נתיב אוויר מלאה על רקע גו"ז בילד בהכרה?',
        ans0: "תמרון היימליך",
        ans1: "טפיחה על הגב",
        ans2: "עידוד שיעול",
        ans3: "ליחצות חזה",
    ...
    {
        quess: 'מהו הטיפול בחסימת נתיב אוויר מלאה על רקע גו"ז במחוסר הכרה?',
        ans0: "החייאה מלאה",
        ans1: "ביצוע ליחצות בצמוד לקיר",
        ans2: "תמרון היימליך",
        ans3: "חיפוש הגוף הזר ושליפתו ידנית",
        img: "#"
    }
