const termList = [
    {
        quess: "מהם תפקידי מערכת העצבים?",
        ans0: "וויסות פעילות כל מערכות הגוף, קבלת מידע מהסביבה, עיבוד ומתן תגובה",
        ans1: "הובלה, וויסות חום הגוף ולוחמה בזיהומים",
        ans2: "להגן על המוח והעצבים",
        ans3: "תמיכה לרקמות הגוף, הגנה על איברים פנימיים ולאפשר תנועה",
        img: "#"
    },
    {
        quess: "מהו ה- CSF?",
        ans0: "נוזל שקוף המקיף את המוח וחוט השדרה המשמש כבולם זעזועים וחומר הזנה למח",
        ans1: "מנגנון הגנה ייחודי למוח המונע מחומרים רבים לעבור מכלי הדם למוח ",
        ans2: "מחבר בין המוח לחוט השדרה ואחראי למרכזים החשובים לחיים",
        ans3: "קרומי המח העוטפים אותו, מגינים עליו ומזינים אותו",
        img: "#"
    },
    {
        quess: "מהו ה- BBB?",
        ans0: "מנגנון הגנה ייחודי למוח המונע מחומרים רבים לעבור מכלי הדם למוח",
        ans1: "נוזל שקוף המקיף את המוח וחוט השדרה במשמש כבולם זעזועים וחומר הזנה למוח",
        ans2: "מחבר בין המוח לחוט השדרה ואחראי למרכזים החשובים לחיים",
        ans3: "קרומי המח העוטפים אותו, מגנים עליו ומזינים אותו",
        img: "#"
    },
    {
        quess: "על מה אחראי המח הגדול?",
        ans0: "זיכרון חשיבה ולימוד",
        ans1: "שיווי משקל, קואורדינציה וטונוס שרירים",
        ans2: "ביצוע תנועות מדוייקות",
        ans3: "אחראי על המרכזים החשובים לחיים",
        img: "#"
    },
    {
        quess: "על מה אחראי המח הקטן?",
        ans0: "שיווי משקל,  קואורדינציה וטונוס שרירים",
        ans1: "זיכרון, חשיבה ולימוד",
        ans2: "מקשר בין מערכת העצבים המרכזית להיקפית",
        ans3: "אחראי על המרכזים החשובים לחיים",
        img: "#"
    },
    {
        quess: "על מה אחראי גזע המוח?",
        ans0: "אחראי על המרכזים החשובים לחיים",
        ans1: "שיווי משקל, קואורדינציה וטונוס שרירים",
        ans2: "זיכרון חשיבה ולימוד",
        ans3: "מקשר בין מערכת העצבים המרכזית להיקפית",
        img: "#"
    },
    {
        quess: "על מה אחראי חוט השדרה?",
        ans0: "מקשר בין מערכת העצבים המרכזית להיקפית",
        ans1: "אחראי על המרכזים החשובים לחיים",
        ans2: "שיווי משקל, קואורדינציה וטונוס לשרירים",
        ans3: "זיכרון, חשיבה ולימוד",
        img: "#"
    },
    {
        quess: "על מה שולטת מערכת העצבים הנשלטת?",
        ans0: "פעולות רצוניות כמו ריצה, דיבור ונגיעה",
        ans1: "פעולות בלתי רצוניות כמו עיכול, נשימה ופעולות הלב",
    ...
    {
        quess: "מה ההבדל בין תגובה עצבית לרפלקס?",
        ans0: "בתגובה עצבית העיבוד קודם לתגובה בעוד ברפלקס התגובה קודמת לעיבוד",
        ans1: "ברפלקס העיבוד קודם לתגובה בעוד בתגובה עצבית התגובה קודמת לעיבוד",
        ans2: "בתגובה עצבית הגירוי קודם לקליטה בעוד ברפלקס הקליטה קודמת לגירוי",
        ans3: "ברפלקס הגירוי קודם לקליטה בעוד בתגובה עצבית הקליטה קודמת לגירוי",
        img: "#"
    },
    {
        quess: "לכמה חלקים מחולק המח?",
        ans0: "2 המיספרות שכל אחת מחולקת ל-4 אונות",
        ans1: "4 המיספרות שכל אחת מחולקת לשתי אונות",
        ans2: "4 אונות שכל אחת מחולקת ל-2 המספרות",
        ans3: "2 אונות שכל אחת מחולקת ל-4 המיספרות",
        img: "#"
    },
    {
        quess: "מה תפקיד השיער בהגנה על המוח?",
        ans0: "הגנה תרמית",
        ans1: "מגן כולא",
        ans2: "הזנת המוח",
        ans3: "בלימת זעזועים",
...
const quesValue = ["0", "100", "200", "500", "1,000", "2,000", "5,000", "10,000", "80,000", "100,000", "200,000", "400,000", "500,000", "800,000", "1,000,000"];
