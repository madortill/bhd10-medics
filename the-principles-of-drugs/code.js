const termList = [
    {
        term: "תרופה",
        explain: "חומר או תרכובת רפואית, המשפיעים על מבנה הגוף ותפקודו."
    },
    {
        term: "התוויה",
        ...
        term: "הוראות מתן",
        explain: "דגשים שעל המטפל להסביר למטופל."
    },{
        term: "שם מסחרי",
        explain: "שם שחברות התרופות משתמשות בו על מנת לשווק את התרופה."
    },{
        term: "התמכרות",
        explain: "מצב של תלות פסיכולוגית ובחלק מהמקרים גם גופנית, בחומר או בפעילות כלשהם. התמכרות מתאפיינת בהתנהגות כפייתית שנועדה להשיג את אותו גירוי. המצב ממשיך גם כאשר הוא מוביל להשלכות שליליות ובא על חשבונם של צרכים חשובים אחרים, פסיכולוגים וגופניים."
    },{
        term: "סבילות",
        ...
        term: "תסמונת גמילה",
        explain: "שורה של תסמינים גופנים ונפשיים אשר מופיעים בעקבות הפסקה חדה בלקיחת החומר באדם שהתמכר אליו. התסמינים הגופניים כוללים בדרך כלל את היפוכן של ההשפעות הפרמקולוגיות של הסם. לדוגמה הוא משכך כאב שגם גורם לעצירות."
    },{
        term: "תקן 15 ד",
        explain: "תרופות מפרוטוקול טיפול חובש ופרוטוקול בעיות עור, אותן יכול החובש לנפק גם ללא מרשם רופא."
    },{
        term: "תקן 15",
        explain: 'רשימה של כ100 תרופות שנמצאות בכל מרפאות צה"ל. תרופות אלו מנופקות למטופלים על ידי החובש או רוקח, אך רק בהצגת מרשם רופא.'
    },{
        term: "טיפול בגורם",
        ...
        term: "מרשם",
        explain: "הוראת רופא בכתב, שעל פיה יכול חובש לנפק תרופה מתקן 15. היא מכילה פרטים כגון: פרטי המטופל, פרטי התרופה והמינון, פרטי הרופא."
    },{
        term: "פרמקולוגיה",
        explain: "מדעי התרופה."
    },{
        term: "חומר פעיל",
        explain: "החומר בתרופה אשר מפעיל את מנגון הריפוי."
    },{
        term: "פלסבו",
        ...
        term: "PV",
        explain: "ואגינלי, בתוך הנרתיק."
    },{
        term: "Buccal",
        explain: "ספיגה בריריות הפה (לחיים)."
    },{
        term: "Topical",
        explain: "מקומי, לדוגמה משחה/טיפות עיניים ואוזניים."
    },{
        term: "Trans Dermal",
        explain: "דרך העור."
    },{
        term: "TAB",
        explain: "טבלית, לרוב נלקחת PO ׁ(דרך הפה, בבליעה)."
    },{
        term: "CAP",
        explain: "קפסולה, לרוב נלקחת PO (דרך הפה, בבליעה)."
    },{
        term: "SOL",
        explain: "נוזל, לרוב נלקח דרך הפה/דרך רירית/באינהלציה."
    },{
        term: "AMP",
        explain: "אמפולה, לצורך הזרקות (IV, IM, SCׁ)."
    },{
        term: "GTT/DRP",
        explain: "טיפות."
    }
